...
export class ModificaArticuloComponent implements OnInit {
  ...
  constructor(private dialogRef: MatDialogRef<ModificaArticuloComponent>,
    ...
    restricciones = new FormControl(this.data.dosificacion, [Validators.required]);
    altTerapeutica = new FormControl(this.data.dosificacion, [Validators.required]);
    observaciones = new FormControl(this.data.dosificacion, [Validators.required]);
