...
@Component({
  ...
  templateUrl: './ingreso-art-oc.component.html',
  styleUrls: ['./ingreso-art-oc.component.css']
})
export class IngresoArtOcComponent implements OnInit {
...
datoArticulo: IdatoArticulo = {
  ...
  constructor(private dialogRef: MatDialogRef<IngresoArtOcComponent>
